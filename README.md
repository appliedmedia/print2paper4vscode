...
Bug reports and pull requests are welcome at [github.com/appliedmedia/print2paper4vscode](<https://github.com/appliedmedia/print2paper4vscode>).

* Development setup, build, and test instructions: [docs/CONTRIBUTING.md](<docs/CONTRIBUTING.md>)
* Architecture, three-library pipeline (Shiki + jsPDF + PDF.js), execution flow: [docs/ARCHITECTURE.md](<docs/ARCHITECTURE.md>)
