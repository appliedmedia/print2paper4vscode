...
describe('UI Abstraction Layer', () => {
  ...
  before(() => {
    ...
    mockApp = {
      ...
      vscodeapis: {
        showSaveDialog: (options: any) => Promise.resolve({
          fsPath: '/tmp/test-output.pdf'
        }),
        showOpenDialog: (options: any) => Promise.resolve([{
  ...
  describe('Toolbar Management', () => {
    it('should add toolbar to HTML', () => {
      const html = '<div>Test content</div>';
      const result = ui.addToolbar(html);
    ...
    it('should handle HTML with existing toolbar', () => {
      const htmlWithToolbar = '<div class="toolbar">Existing toolbar</div><div>Content</div>';
      const result = ui.addToolbar(htmlWithToolbar);
  ...
  describe('HTML Processing', () => {
    it('should preserve HTML structure', () => {
      ...
      const result = ui.addToolbar(complexHtml);
    ...
    it('should handle HTML with scripts and styles', () => {
      ...
      const result = ui.addToolbar(htmlWithScripts);
    ...
    it('should handle malformed HTML gracefully', () => {
      ...
      const result = ui.addToolbar(malformedHtml);
