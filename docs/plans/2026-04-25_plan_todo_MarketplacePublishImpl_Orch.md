...
* 2026-06-02: Video not required. Marketplace doesn't embed `<video>` tags; only inline GIFs render. The 7 PNG screenshots + walkthrough panel are sufficient for v1.0.0 and all future versions. Removed from scope permanently.
