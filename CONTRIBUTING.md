...
3. **Make your changes** and adhere to the coding standards (see the Coding Standards section below and the Architecture section of the root [README.md](<README.md>)).
