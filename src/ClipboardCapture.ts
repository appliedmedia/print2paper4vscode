...
export class ClipboardCapture {
    ...
    async captureFromActiveTab(): Promise<string | null> {
        try {
            ...
            if (this.app) this.app.ui.debugOut('Error capturing from active tab', 'error', 'ClipboardCapture', error);
            return null;
        }
    }
    ...
    async captureWithEditorCheck(): Promise<string | null> {
        try {
            ...
            if (this.app) this.app.ui.debugOut('Error in captureWithEditorCheck', 'error', 'ClipboardCapture', error);
            return null;
        }
    }
