...
exports.UI = exports.kUI = void 0;
const UIMenu_1 = require("./UIMenu");
// UI persist keys - union of menu IDs and toolbar position
exports.kUI = [...UIMenu_1.kMenuId, 'toolbar_pos', 'zoomLevel_value'];
/**
...
class UI {
    ...
    static kToolbar_pos_min_px = 8;
    static kToolbar_pos_max_px = 5120; // Reasonable max for 5K displays
    reg;
    fn;
    ...
    constructor(args) {
        ...
        this.fn = this.reg.use('vscodeapis.showInformationMessage', 'vscodeapis.showErrorMessage', 'vscodeapis.showWarningMessage', 'vscodeapis.showSaveDialog', 'vscodeapis.uriFromPath', 'vscodeapis.uriToPath', 'yaml.create', 'persist.get', 'persist.set', 'utils.templateDictReplace', 'uimenumgr.getUIMenus_HTML', 'uimenumgr.getUIMenus_CSS', 'uimenumgr.getUIMenus_JS');
    ...
    templateDictReplace(template, dict) {
    ...
    async chooseSaveLocation(defaultFilename) {
